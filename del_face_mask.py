...
without_mask = 0
other_mask = 0
ImgPath = r'D:\python_files4\compition\yolov5-master\yolov5-master\data\data\train_images\206.png'
AnnoPath = r'D:\python_files4\compition\yolov5-master\yolov5-master\data\data\train_annotations\206.xml'
...
#打开xml文档
DOMTree = xml.dom.minidom.parse(AnnoPath)
# 得到文档元素对象
